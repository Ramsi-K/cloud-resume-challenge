...
Building a lightweight MCP-compliant note reader inspired by GoodReader/Notion. Focus: PDF parsing, highlight detection, and automated note syncing to Notion.

[Project Repo →](https://github.com/Ramsi-K/kiroween-skeleton)
